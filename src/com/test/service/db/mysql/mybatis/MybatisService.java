package com.test.service.db.mysql.mybatis;
...
public class MybatisService extends AbstractBaseServerService {
	...
	public void init() throws Exception {
		...
		InputStream inputStream = Resources
				.getResourceAsStream(SeasonsStartServer.mabatisRoot
						+ "mybatis-config.xml");
		 ...
		 */
		Properties jdbcProperties = queryServerConf(SeasonsStartServer.configRoot
				+ "jdbc.properties");
		SqlSessionFactory sqlSessionFactory = new SqlSessionFactoryBuilder()
