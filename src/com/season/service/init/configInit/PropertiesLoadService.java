...
import com.season.service.init.configInit.propertiesBeans.BasePropertiesBean;
import com.season.service.init.configInit.propertiesBeans.ServerPropertiesBean;
...
public class PropertiesLoadService extends AbstractBaseServerService {
	...
	public static BasePropertiesBean getBeanByProperties(
		...
		SeasonLogTools.getLog().info(
				"property:" + CommonTools.writeValueAsString(bean));
		return bean;
	}
